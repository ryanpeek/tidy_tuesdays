...
rds <- here::here("data", "canada_treecover_agg.Rds")

if (!file.exists(rds)) {
  raster_canada_120 <-
    raster(here::here("data", "Hansen_GFC2015_treecover2000_60N_120W.tif")) %>%
    aggregate(., fact = 25)

  raster_canada_130 <-
    raster(here::here("data", "Hansen_GFC2015_treecover2000_60N_130W.tif")) %>%
    aggregate(., fact = 25)
...
ggsave(here::here("figs", "2020_26_Caribous_a_map.pdf"),
...
ggsave(here::here("figs", "2020_26_Caribous_b_herds2.pdf"),
...
ggsave(here::here("figs", "2020_26_Caribous_c_density.pdf"),
       width = 9.7, height = 12, device = cairo_pdf)
```
...
ggsave(here::here("figs", "2020_26_Caribous_full.pdf"),
       width = 34, height = 13, device = cairo_pdf)

## convert to png
pdfs <- list.files(here::here("figs"), pattern = "*.pdf")
setwd(here::here("figs"))
for(pdf in pdfs) {
  pdftools::pdf_convert(pdf = here::here("figs", pdf),
              format = "png", dpi = 180)
}
```
