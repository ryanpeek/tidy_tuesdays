...
```{r getfonts, echo=F, eval=F}

# fix or add missing fonts:
library(extrafont)
#loadfonts()
#fonts() # check font list

library(showtext)

# download from google fonts: # do once per session
font_add_google(name = "Bebas Neue",   # Name of the font on the Google Fonts site
                family = "Bebas Neue") # Name you want to use to call the font

font_add_google(name = "Playfair Display",
                family = "Playfair Display")

font_add_google(name = "Arapey",
                family = "Arapey")
